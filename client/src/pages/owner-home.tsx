...
import { Store, Settings, Plus, Edit, Eye, Clock, MapPin, Users } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Restaurant Owner</h1>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700">
                  Your restaurant owner account is pending admin approval. You can set up your restaurant profile, 
                  but it won't be visible to customers until approved.
                </p>
              </div>
            </div>
          </div>
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 mb-4">You haven't created your restaurant profile yet.</p>
                    <Button
                      onClick={() => setLocation("/owner/restaurant/edit")}
                      className="flex items-center gap-2"
                    >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={hasRestaurant ? getStatusColor(restaurant.status || "pending") : "bg-gray-100 text-gray-800"}>
                    {hasRestaurant ? (restaurant.status || "pending") : "Not Created"}
                  </Badge>
                </div>
                <div className="flex items-center justify-between">
            ...
            <CardContent className="py-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6 max-w-md mx-auto">
                  Create your restaurant profile to start accepting orders from customers. 
                  Add your restaurant details, menu items, and start building your business.
                </p>
                <Button
                  onClick={() => setLocation("/owner/restaurant/edit")}
                  className="flex items-center gap-2"
