...
import { ArrowLeft, Plus, Star, MapPin, Clock, ShoppingCart } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <Button variant="outline" onClick={() => setLocation("/customer/home")}>
                <ArrowLeft className="h-4 w-4 mr-2" />
                Back
              </Button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="flex items-center gap-4 text-gray-600 mb-3">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <Badge 
                      ...
                      className={restaurant.status === 'open' ? 'bg-green-100 text-green-800' : ''}
                    >
                      {restaurant.status}
                    </Badge>
                  </div>
        ...
        {restaurant.status !== 'open' && (
          <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-yellow-800 font-medium">
              This restaurant is currently {restaurant.status}. You may not be able to place orders at this time.
            </p>
          </div>
        )}
        ...
        {foodItems && foodItems.length > 0 ? (
          <Tabs defaultValue={Object.keys(groupedFoodItems)[0]} className="w-full">
            <TabsList className="grid w-full mb-6" style={{ gridTemplateColumns: `repeat(${Object.keys(groupedFoodItems).length}, minmax(0, 1fr))` }}>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-500">This restaurant hasn't added any food items yet.</p>
          </div>
        )}
      </div>
    </div>
